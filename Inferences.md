...
**Висновок:**
Отримані дані повністю відповідають очікуваним результатам для Завдання 7. Тож успішно застосовано метод Монте-Карло для апроксимації аналітичних ймовірностей кидків двох кубиків.
